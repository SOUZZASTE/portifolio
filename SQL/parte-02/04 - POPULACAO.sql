...
INSERT INTO Aluguel
(data_retirada,data_prev_devolucao,data_devolucao,dias_atraso,cliente_id,filme_id,funcionario_id)VALUES
("2018-05-18","2018-05-25","2018-05-28",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),14,5,2),
("2021-03-03","2021-03-10","2021-06-10",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),2,22,6),
("2017-12-08","2017-12-13","2017-12-13",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),26,15,8),
("2023-06-12","2023-06-19","2023-06-19",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),10,30,5),
("2019-03-28","2019-04-02","2019-04-10",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),17,2,2),
("2017-04-30","2017-05-05","2017-05-04",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),9,9,2),
("2022-02-17","2022-02-22","2022-02-22",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),1,12,5),
("2019-11-22","2019-11-27","2019-11-27",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),15,18,6),
("2021-07-27","2021-08-01","2021-09-01",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),21,31,11),
("2018-01-25","2018-02-01","2018-02-01",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),23,10,1),
("2020-04-05","2020-04-12","2020-04-12",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),2,8,8),
("2017-03-12","2017-03-17","2017-03-25",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),17,4,2),
("2023-02-10","2023-02-17","2023-02-17",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),8,5,10),
("2023-02-10","2023-02-17","2023-02-17",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),18,5,1),
("2020-10-05","2020-10-12","2020-10-12",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),6,17,6),
("2018-09-15","2018-09-22","2018-09-22",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),11,27,8),
("2021-08-20","2021-08-27","2021-09-01",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),22,25,4),
("2018-07-17","2018-07-24","2018-07-24",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),19,7,5),
("2022-06-12","2022-06-19","2022-06-19",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),16,11,4),
("2019-04-23","2019-04-30","2019-04-30",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),25,14,2),
("2018-07-19","2018-07-26","2018-07-26",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),3,1,1),
("2021-10-01","2021-10-08","2021-10-08",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),26,3,8),
("2019-02-13","2019-02-20","2019-02-20",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),10,23,2),
("2023-06-10","2023-06-15","2023-06-16",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),4,26,1),
("2020-05-18","2020-05-23","2020-05-23",TIMESTAMPDIFF(DAY,data_prev_devolucao,data_devolucao),12,6,4);
